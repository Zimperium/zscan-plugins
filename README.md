...
1. [**Jenkins**](https://github.com/jenkinsci/zscan-upload-plugin): Integrate zScan directly into your Jenkins pipeline, enabling automated security scans for every build.
